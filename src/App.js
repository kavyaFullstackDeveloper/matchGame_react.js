        ...
        <div className="main-container">
          {!isTrue && (
            <div className="sub-container-1">
              <div>
                <img src={imgUrl} className="main-image" alt="match" />
                    ...
                    <li key={each.tabId}>
                      <button
                        ...
                        className={`tab-button ${
                          category === each.tabId ? 'highlighted' : ''
                        }`}
                        onClick={() => this.clickTab(each.tabId)}
                      >
                        {each.displayText}
                      </button>
                    </li>
                  ...
                  {thumbnailList.map(each => (
                    <li key={each.id}>
                      <button
                        ...
                        onClick={() => this.imageClick(each.thumbnailUrl)}
                      >
                        <img
